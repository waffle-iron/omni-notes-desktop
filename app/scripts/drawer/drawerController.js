angular.module('ONApp').controller('drawerController', ["$scope", '$q', '$log', '$mdDialog', 'notesService', function($scope, $q, $log, $mdDialog, notesService) {
  ...
  // Menu items
    ...
    {
      method: 'filterNotes',
      params: function(note){return !note.archived && !note.trashed;},
      title: 'Notes',
      icon: 'insert_drive_file'
    },
    {
      method: 'filterNotes',
      params: function(note){return note.alarm;},
      title: 'Reminders',
      icon: 'alarm'
    },
    {
    ...
    {
      method: 'filterNotes',
      params: function(note){return note.trashed;},
      title: 'Trash',
      icon: 'delete'
    },
    {
      method: 'filterNotes',
      params: function(note){return !note.category;},
      title: 'Uncategorized',
      icon: 'folder_open'
    }
  ];
